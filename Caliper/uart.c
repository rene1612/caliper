...
**************************************************************************/
/**
 *  @brief   Put count bytes to ringbuffer for transmitting via UART
 *  @param   * to data bytes to be transmitted
 *  @return  none
 */
extern unsigned char uart_write(unsigned char *data, unsigned char count)
{
